...
def build_single_file():
    print("Building standalone CasinoPlanet.html...")
    ...
    # Write output
    output_path = os.path.join(project_dir, "CasinoPlanet.html")
    with open(output_path, "w", encoding="utf-8") as f:
        f.write(html_content)
        
    print(f"SUCCESS: Standalone game packaged successfully at: {output_path}")
